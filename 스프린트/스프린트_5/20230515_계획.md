...
1. Study Admin
2. Study Owner
3. Study Defintion, Study Design 담당자
4. CRF, DCI 담당자
5. SDTM 담당자
...
2. 추가 가능
3. Context, Name 중 하나라도 공란인 경우 저장 누르면 그 행 사라짐
4. Context CDASH인 경우 NAME에서 도메인 검색 가능
6. Visit, Form에선 Context, Name 프리텍스트
7. Item Group에선 Context CDASH인 경우 Name에서 도메인 선택 및 수정 가능
